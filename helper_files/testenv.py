...
class TestCog:
    ...
    # this command is used by the TEST guild to ensur that each TEST container will only process incoming commands that originate from 
    # channels that match the name of their branch
    @staticmethod
    ...
    # this command is used by the TEST guild to create the channel from which this TEST container will process commands
