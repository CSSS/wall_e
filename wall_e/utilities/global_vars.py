...
sys_warn_log_file_absolute_path = log_info[2]
sys_error_log_file_absolute_path = log_info[3]
...
wall_e_warn_log_file_absolute_path = log_info[2]
wall_e_error_log_file_absolute_path = log_info[3]
