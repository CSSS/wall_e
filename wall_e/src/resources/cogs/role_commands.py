...
class RoleCommands(commands.Cog):
    ...
    async def get_bot_channel(self, bot_channel_manager):
        self.bot_channel = await bot_channel_manager.get_bot_channel(acquire_channel=True)
        self.bot_channel_acquired = True
